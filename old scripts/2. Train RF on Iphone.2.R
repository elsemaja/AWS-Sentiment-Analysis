...
# make sure Recode is set as factor
...
setTest$Recode <- as.factor(setTest$Recode)
setTest$predSentimentIphone_RF <- as.factor(setTest$predSentimentIphone_RF)
caret :: confusionMatrix(setTest$predSentimentIphone_RF, setTest$Recode)
...
setTest$errors <- setTest$Recode - setTest$predSentimentIphone_RF
